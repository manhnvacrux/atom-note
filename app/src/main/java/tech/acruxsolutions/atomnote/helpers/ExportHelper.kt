package tech.acruxsolutions.atomnote.helpers
...
import tech.acruxsolutions.atomnote.activities.AtomNoteActivity
...
import tech.acruxsolutions.atomnote.xml.Backup
...
import tech.acruxsolutions.post.PostPDFGenerator
import java.io.File
...
class ExportHelper(private val context: Context, private val fragment: Fragment) {
    ...
    fun exportBackup() {
        val backupFile = File(getExportedPath(), "AtomNote Backup.xml")
    ...
    fun exportFileToPlainText(file: File) {
        ...
        val formatter = SimpleDateFormat(AtomNoteActivity.DateFormat, context.getLocale())
